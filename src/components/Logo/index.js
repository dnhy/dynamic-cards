...
export const CustomLogo = memo((props) => {
    ...
    if (logoSvg) {
        return (_jsx("div", { className: className, style: { height }, 
            // @ts-expect-error: onAnimationEnd is not a valid prop for div
            onAnimationEnd: onAnimationEnd, dangerouslySetInnerHTML: {
                __html: logoSvg,
            } }));
    }
    return _jsx(DefaultLogo, { ...props });
});
