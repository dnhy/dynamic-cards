        ...
        >
          ...
          <div className="w-full flex justify-center info-wrap text-white/[0.7] absolute bottom-[20%] z-10">
            <p className="w-[70%] text-center tracking-[1px]">
              ...
              Whether you're seeking adventure, relaxation, or a taste of
              India's unique traditions, Kerala has something for everyone. From
              the lush hill stations to pristine beaches, and Ayurvedic retreats
              to vibrant festivals, this enchanting state offers a perfect blend
